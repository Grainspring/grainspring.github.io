...
###V8WindowShell::initializeIfNeeded
...
###V8WindowShell::installDOMWindow
...
###V8WindowShell::updateDocumentProperty
...
277         else {
278             OwnPtr<V8WindowShell> isolatedWorldShell = V8WindowShell::create(m_frame, world, m_isolate);// create V8WindowShell.
279             shell = isolatedWorldShell.get();
280             m_isolatedWorlds.set(world->worldId(), isolatedWorldShell.release());
281         }
282     }
283     if (!shell->isContextInitialized() && shell->initializeIfNeeded()) { // may create v8::Context.
